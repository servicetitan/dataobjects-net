...
namespace Xtensive.Tuples.Transform
{
  ...
  {
    private readonly Segment<ColNum> segment;
    ...
    /// </summary>
    public ref readonly Segment<ColNum> Segment
    {
    ...
    internal SegmentTransform(TupleDescriptor sourceDescriptor, in Segment<ColNum> segment)
    {
      IsReadOnly = false;
      Descriptor = sourceDescriptor.Segment(segment);
      this.segment = segment;
