...
namespace Xtensive.Sql
{
  ...
  public static class SqlDdl
  {
    ...
    {
      ArgumentNullException.ThrowIfNull(assertion, "assertion");
      return new SqlCreateAssertion(assertion);
    }

    public static SqlCreateCharacterSet Create(CharacterSet characterSet)
    {
      ArgumentNullException.ThrowIfNull(characterSet, "characterSet");
    ...
    {
      ArgumentNullException.ThrowIfNull(partitionFunction, "partitionFunction");
    ...
    {
      ArgumentNullException.ThrowIfNull(partitionSchema, "partitionSchema");
    ...
    {
      ArgumentNullException.ThrowIfNull(translation, "translation");
      return new SqlCreateTranslation(translation);
    }

    public static SqlCreateView Create(View view)
    {
      ArgumentNullException.ThrowIfNull(view, "view");
    ...
    {
      ArgumentNullException.ThrowIfNull(partitionFunction, "partitionFunction");
      ArgumentNullException.ThrowIfNull(booundary, "booundary");
    ...
    {
      ArgumentNullException.ThrowIfNull(defaulValue, "defaulValue");
