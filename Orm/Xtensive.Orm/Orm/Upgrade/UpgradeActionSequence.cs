...
namespace Xtensive.Orm.Upgrade
{
  ...
  public sealed class UpgradeActionSequence : IEnumerable<string>
  {
    ...
    {
      ArgumentNullException.ThrowIfNull(regularProcessor, nameof(regularProcessor));
      ArgumentNullException.ThrowIfNull(nonTransactionalProcessor, nameof(nonTransactionalProcessor));
