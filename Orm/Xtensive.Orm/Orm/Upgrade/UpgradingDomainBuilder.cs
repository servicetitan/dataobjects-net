...
namespace Xtensive.Orm.Upgrade
{
  internal sealed class UpgradingDomainBuilder
  {
    ...
    {
      ArgumentNullException.ThrowIfNull(parentDomain, nameof(parentDomain));
      ArgumentNullException.ThrowIfNull(nodeConfiguration, nameof(nodeConfiguration));
    ...
    private StorageNode BuildStorageNode(Domain domain, SchemaExtractionResult extractedSchema)
    {
      ...
      var result = new StorageNode(domain, context.NodeConfiguration, modelMapping, new TypeIdRegistry(domain.Model.Types.SharedIdToTypeInfo));
